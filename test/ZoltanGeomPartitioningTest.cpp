...
int main (int argc, char* argv[]) {
    ...
    std::cout << "Partitioning with Zoltan Geometry methods..." << std::endl;
    std::string execution_call = std::string("mpirun -np 8 ") +
                                 ...
                                 //std::string(" ../../data/Watermarking/" + selected_mesh + "/" + selected_mesh + "_RIB.txt");
                                 std::string(" ../../data/Watermarking/" + selected_mesh + "/" + selected_mesh + "_HSFC.txt");
                                 //std::string(" ../../data/Watermarking/" + selected_mesh + "/" + selected_mesh + "_REFTREE.txt");
    stopwatch.start();
    ...
    //std::vector<Mesh> meshes = mesh_manager.breakMesh(mesh,std::string("../../data/Watermarking/" + selected_mesh + "/" + selected_mesh + "_RIB.txt"));
    std::vector<Mesh> meshes = mesh_manager.breakMesh(mesh,std::string("../../data/Watermarking/" + selected_mesh + "/" + selected_mesh + "_HSFC.txt"));
    //std::vector<Mesh> meshes = mesh_manager.breakMesh(mesh,std::string("../../data/Watermarking/" + selected_mesh + "/" + selected_mesh + "_REFTREE.txt"));
    elapsed_time = stopwatch.stop();
    total_time = total_time + elapsed_time;
    std::cout << "DONE in " << elapsed_time << " seconds" << std::endl << std::endl;
    ...
    //input_manager.writeMeshToOff(meshes,std::string("../../data/Watermarking/" + selected_mesh + "/ZoltanRIB/" + selected_mesh));
    input_manager.writeMeshToOff(meshes,std::string("../../data/Watermarking/" + selected_mesh + "/ZoltanHSFC/" + selected_mesh));
    //input_manager.writeMeshToOff(meshes,std::string("../../data/Watermarking/" + selected_mesh + "/ZoltanREFTREE/" + selected_mesh));
    elapsed_time = stopwatch.stop();
    total_time = total_time + elapsed_time;
    std::cout << "DONE in " << elapsed_time << " seconds" << std::endl << std::endl;
